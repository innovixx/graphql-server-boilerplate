import { z } from 'zod';
import type { Prisma } from '../../../../databases/maindb/client/client.js';
...
export const TestUpdateManyAndReturnArgsSchema: z.ZodType<Prisma.TestUpdateManyAndReturnArgs> = z.object({
  data: z.union([ TestUpdateManyMutationInputSchema,TestUncheckedUpdateManyInputSchema ]),
  where: TestWhereInputSchema.optional(),
  limit: z.number().optional(),
}).strict() ;
